...
folder_id = '16Vv3KS-5eAMYr0eF6OeHB3PVJNMJBoiA'


# def filesIDs(id_folder, size) :
#     dictOfAll = {}
#     query = "mimeType='image/jpeg' or mimeType='image/png' and trashed = false and parents in '" + folder_id + "' and size <= " + str(size)
#     page_token = None
#     while True:
...
#             # print the id and name of the image
#             print(u'{0} ({1})'.format(file.get('name'), file.get('id')))
#             dictOfAll[file.get('name')] = file.get('id')
#
#         # set up the page token for the next page of images (if it exists)
